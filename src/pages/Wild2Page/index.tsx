...
export default function Wild2Page() {
  ...
  return (
    <div className={S.container}>
      <div className={S.containerTitle}>Wild2 - Game Verification Script</div>
      <div className={S.containerSubTitle}>
        Third party script used to verify Wild2 game results.
      </div>
      ...
      <div className={S.break}></div>
      <div className={S.description}>
        We made the decision to update Wild2 using a salted hash as requested by
