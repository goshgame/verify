  ...
  return (
    <div className={S.container}>
      <div className={S.containerTitle}>
        SAPPHIRE - Game Verification Script
      </div>
      <div className={S.containerSubTitle}>
        Third party script used to verify SAPPHIRE game results.
      </div>
      ...
      <div className={S.break}></div>
      <div className={S.description}>
        We made the decision to update SAPPHIRE using a salted hash as requested
