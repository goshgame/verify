  ...
  return (
    <div className={S.container}>
      <div className={S.containerTitle}>
        High Roller - Game Verification Script
      </div>
      <div className={S.containerSubTitle}>
        Third party script used to verify High Roller game results.
      </div>
      ...
      <div className={S.break}></div>
      <div className={S.description}>
        We made the decision to update High Roller using a salted hash as
